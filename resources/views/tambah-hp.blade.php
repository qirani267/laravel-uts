...
<div class="card-body">
<div class="container">
<form action="/simpan-hp" method="POST" >
    <div class="form-group">
        <label for="merk_hp">Merk hp : </label>
        <input class="form-control" type="text" name="merk_hp" id="merk_hp">
    </div>
    <div class="form-group">
        <label for="type_hp">Tipe hp : </label>
        <input class="form-control" type="text" name="type_hp" id="type_hp">
    </div>
    <div class="form-group">
